library kiwiflag_v1_api.console;

import "package:google_oauth2_client/google_oauth2_console.dart" as oauth2;

import 'package:google_kiwiflag_v1_api/src/console_client.dart';

import "package:google_kiwiflag_v1_api/kiwiflag_v1_api_client.dart";

/** This is an API */
class Kiwiflag extends Client with ConsoleClient {
  ...
  Kiwiflag([oauth2.OAuth2Console this.auth]);
}
